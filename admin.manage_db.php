...
<body onload="myFunction()" style="margin:0;">
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Manage Database</li>
      </ol>
    </nav>
        <br>
...
<!-- MODAL BUTTONS -->
                        ...
                        <a href="#edit<?php echo $id;?>" data-toggle="modal">
                            <button disabled type='button' class='btn btn-warning btn-sm'><span class='fa fa-edit' aria-hidden='true'></span> Edit</button>
                        </a>
                        <!-- <a href="#download<?php echo $id;?>" data-toggle="modal">
                            <button disabled type='button' class='btn btn-primary btn-sm'><span class='fa fa-download' aria-hidden='true' ></span> Download</button>
                        </a> -->
                        <a href="#delete<?php echo $id;?>" data-toggle="modal">
                            <button disabled type='button' class='btn btn-danger btn-sm'><span class='fa fa-trash' aria-hidden='true'></span> Delete</button>
                        </a>
                    </td>
<!-- VIEW MODAL -->
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <input type="text" class="form-control" id="" name=""  required readonly value="
                                                <?php 
                                                    echo $author_1;
                                                    if($author_2 != '')
                                                    {    echo ', '. $author_2;   }  
                            ...
                            <form method="post">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" name="delete" class="btn btn-primary"><span class="fa fa-download"></span> Download</button>
